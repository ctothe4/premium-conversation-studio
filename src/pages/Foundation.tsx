  ...
  return (
    <Layout>
        ...
        <div className="container-editorial">
          ...
          >
            <h1 className="headline-section mb-8">
              Before growth,
              <br />
              <span className="text-primary">you need a foundation.</span>
            </h1>
      ...
      <AnimatedSection className="section-padding-sm border-t border-border">
        <div className="container-editorial">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            <div>
              <p className="subheadline mb-6">Who This Is For</p>
            ...
            <div>
              <ul className="space-y-5">
                {[
                  ...
                  "Businesses relying on social platforms",
                  "Owners who want legitimacy and ownership",
                  "Teams that want a base they won't have to redo",
                ].map((item) => (
      ...
      <AnimatedSection className="section-padding border-t border-border">
        <div className="container-editorial">
          <div className="max-w-3xl mx-auto text-center">
            <p className="subheadline mb-6">The Real Risk</p>
            <h2 className="headline-card mb-8">
              The risk is invisible until it isn't
            </h2>
            <p className="body-large text-muted-foreground">
              Operating without a website can work until customers search you. When you don't control what they see, you don't control first impressions or credibility. A foundation isn't about traffic. It's about ownership.
            </p>
          </div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection className="section-padding-sm border-t border-border">
        <div className="container-editorial">
          <div className="max-w-3xl mx-auto text-center">
            <p className="subheadline mb-6">Our Approach</p>
            <h2 className="headline-card mb-8">
              We start with a review, not a build
            </h2>
            <p className="body-large text-muted-foreground">
              We begin with a Digital Presence Review to see what customers see today, where trust breaks down, and what the minimum credible setup should be. Then we recommend next steps.
            </p>
          </div>
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection className="section-padding border-t border-border">
        <div className="container-editorial">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            <div>
              <p className="subheadline mb-6">What You Get</p>
              <h2 className="headline-card mb-8">
            ...
            <div>
              <ul className="space-y-5">
                {[
                  "Professional website designed for clarity and trust",
                  "Mobile-first, fast loading, easy to navigate",
